        ...
        <div class="row">
            ...
            <div class="col-sm-3 d-flex justify-content-between align-items-center">
                <a class="btn btn-primary "
                    href="{{ route('superadmin.order_statuses.edit', ['order_status' => $order_status]) }}">
                    Edit
                </a>
                <form action="{{route('superadmin.order_statuses.update', ['order_status' => $order_status])}}" method="POST">
                    @csrf
                    @method('PUT')
