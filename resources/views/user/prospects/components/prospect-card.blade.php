            ...
            <div class="col-sm-3">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item" href="{{ route('user.prospects.edit', ['prospect' => $prospect])}}">Edit</a></li>
                      <li><a class="dropdown-item" href="{{route('user.orders.create.select_products', ['prospect' => $prospect])}}">Make An Order For "{{$prospect->name}}"</a></li>
                      <li><a class="dropdown-item" href="{{route('user.prospects.show-orders', ['prospect' => $prospect])}}">View Orders Of "{{$prospect->name}}"</a></li>
                      <li><form action="{{ route('user.prospects.destroy', ['prospect' => $prospect]) }}" method="POST">
                        @csrf
                        @method('DELETE')
