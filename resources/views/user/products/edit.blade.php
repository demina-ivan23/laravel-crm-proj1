...
@section('content')
    <div class="container">
        <div class="card mt-4">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                @can('view', \App\Models\Product::class)
                                    ...
                                    <li><a class="dropdown-item"
                                            href="{{ route('user.products.show', ['product' => $product]) }}">View</a>
                                    </li>
                                @endcan
            ...
            <form action="{{ route('user.products.update', ['product' => $product]) }}" method="POST"
                ...
                <div class="p-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="title" id="title"
                            placeholder="Product's title..." value="{{ $product->title }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="description" id="description"
                            placeholder="No description yet..." value="{{ $product->description }}">
                    </div>
                    <div class="mb-3">
                        <label for="name" class="form-label">Price</label>
                        <input class="form-control" type="text" name="price" id="price"
                            placeholder="Product's price..." value="{{ $product->price }}">
                    </div>
                    <div class="mb-3">
